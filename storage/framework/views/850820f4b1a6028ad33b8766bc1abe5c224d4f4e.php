...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.html">Uti Fiore</a>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      <li class="nav-item active">
        ...
        <a class="nav-link" href="<?php echo e(route('invoice.create')); ?>">
          <i class="fas fa-fw fa-table"></i>
...
<?php /* C:\xampp\htdocs\latihan_laravel\resources\views/layouts/app.blade.php */ ?>